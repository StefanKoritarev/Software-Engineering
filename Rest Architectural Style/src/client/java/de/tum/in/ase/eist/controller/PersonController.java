...
public class PersonController {
    ...
    public void getAllPersons(PersonSortingOptions personSortingOptions, Consumer<List<Person>> personsConsumer) {
        webClient.get()
                .uri(uriBuilder -> uriBuilder
                        .path("persons")
                        .queryParam("sortField", personSortingOptions.getSortField())
                        .queryParam("sortingOrder", personSortingOptions.getSortingOrder())
                        .build())
                .retrieve()
