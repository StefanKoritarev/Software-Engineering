...
public class PersonResource {
    ...
    @GetMapping("/persons")
    public ResponseEntity<List<Person>> getAllPersons(@RequestParam("sortingOrder") PersonSortingOptions.SortingOrder sortingOrder, @RequestParam("sortField") PersonSortingOptions.SortField sortField) {

        PersonSortingOptions personSortingOptions = new PersonSortingOptions(sortingOrder, sortField);

        List <Person> persons = personService.getAllPersons(personSortingOptions);
